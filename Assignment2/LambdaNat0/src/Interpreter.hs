...
evalCBN (EApp e1 e2) = case (evalCBN e1) of
    ...
    e3 -> EApp e3 e2
----------------------------------------------------
--- YOUR CODE goes here for extending the interpreter  WILL ADD 2 LINES INSIDE THE CASE STATEMENT
----------------------------------------------------
--evalCBN (ENtS e') = ENatS (evakCBN e')
    evalCBN Enat0 = Enat0
...
evalCBN enatS exp3 = enatS evalCBN
evalCBN enatS exp3 = enatS evalCBN exp3
-- he uses variables a b change it to eS
--base case for substitute is same as for evalCBn
